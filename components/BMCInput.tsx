  ...
  return (
    <div className="w-full max-w-screen-2xl mx-auto p-4 md:p-8 pb-32">
      <div className="text-center mb-10 mt-2">
        {/* <h2 className="text-3xl md:text-3xl font-bold text-slate-800 mb-4 tracking-tight">
          Providing accurate information about your business will make the
          analysis more accurate
        </h2> */}
        {/* <p className="text-lg text-slate-500 max-w-3xl mx-auto font-normal">সঠিক তথ্য দিলে এনালাইসিস আরও নিখুঁত হবে।</p> */}
        {/* <h3 className="text-lg text-slate-500 max-w-5xl mx-auto font-normal">
          Providing accurate information about your business will make the
          analysis more accurate.
        </h3> */}
      </div>
