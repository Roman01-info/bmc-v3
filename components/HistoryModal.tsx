...
import { X, Clock, RotateCcw, Trash2, FileText, Download, FileType } from 'lucide-react';
            ...
            history.map((item) => (
              ...
              >
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 text-xs font-bold text-indigo-600 mb-2 bg-indigo-50 px-2 py-1 rounded-md w-fit">
                    <Clock size={12} />
                  ...
                  <div className="flex items-center gap-2 text-slate-500 text-sm truncate">
                    <span className="bg-slate-100 px-2 py-0.5 rounded text-xs font-medium">Customer</span>
                    {item.data.customerSegments || 'N/A'}
                  </div>
                </div>
